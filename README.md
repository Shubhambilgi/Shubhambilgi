...
<h3 align="center">IT Graduate · Building, Analyzing, and Securing Software</h3>

<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&pause=1000&color=58A6FF&center=true&vCenter=true&width=650&lines=Web+Development+%7C+Data+Analytics+%7C+Cybersecurity;React+%2B+TypeScript+%2B+Python+%2B+SQL;Turning+data+into+dashboards%2C+ideas+into+apps;Always+learning%2C+always+building." alt="Typing SVG" />
</p>
...
- 🔭 Currently building: React/TypeScript apps and Python-based tools
- 🌱 Currently learning: Advanced web app security, VAPT methodologies, threat detection
- 🎯 Open to: Software Development · Data Analytics · Cybersecurity / VAPT roles
- ⚡ I like projects that involve building *and* breaking things to see how they hold up
...
React, TypeScript, Node.js, REST APIs, and MySQL — building responsive, full-stack applications.
...
Data cleaning & transformation, KPI tracking, dashboard development, and trend analysis.
...
Web app security testing, VAPT, SQL injection & XSS testing, auth/access-control testing, network enumeration, and log analysis.

> ⚠️ Security testing shown here is performed only against authorized systems, labs, or intentionally vulnerable applications.
...
<p align="center">
  <i>Let's build, analyze, and secure something together. 🚀</i>
</p>
